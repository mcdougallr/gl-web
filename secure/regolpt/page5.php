	...
	<div id="gl-main">
		<div id="gl-wrapper">
	      ...
	      <div class="pure-g">	      	
		    		...
		    		<p>Does <?php print $data['student_name_common']; ?> have any siblings registering for Gould Lake courses in 2016? Please provide their names and the course for which they are registering.</p>
			    ...
			    <div class="pure-u-1">
					...
					<?php 
						...
						$programarray = array("oe"=>"Outdoor Escape","gap"=>"GAP","q"=>"Quest","outreach"=>"Outreach","op"=>"Outdoor Pursuits","os"=>"Outdoor Skills","solo"=>"SOLO","wic"=>"WIC","kic"=>"KIC");
						$j = 0;
					...
					<div class="pure-u-1">
						...
						<p>To ensure student safety, Limestone District School Board policy does not allow non-swimmers 
								...
								swim at least 40 metres and tread water for 5 minutes. </p>
	  				<div class="pure-g">
		   				<div class="pure-u-1 pure-u-sm-3-4">
								<label>Can <?php print $data['student_name_common']; ?> swim 40m and can tread water for 5 minutes without assistance</label>
				    	</div>
