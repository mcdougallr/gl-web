...
?>
		...
		<div id="gl-wrapper">   
	      <div class="pure-g">	      	
					<div class="pure-u-1">	    
						...
						<p>In order to complete your registration, please print out the registration package, ensure the information is correct and sign the necessary documents. Please mail the completed package to:</p>
	...
	$emailcontent = $emailcontent."https://outed.limestone.on.ca/secured/olpreg16/forms.php?rid=".$data['registration_id']."&rcd=".$data['registration_code']."\n\n";
	
	$emailcontent = $emailcontent."Student: ".$data['student_name_first']. " ". $data['student_name_last']. "\n";
	
	$emailcontent = $emailcontent."School for Fall 2016: ".$data['student_school_fall']. "\n";
	$emailcontent = $emailcontent."Current Grade: ".$data['student_grade']. "\n";
	$emailcontent = $emailcontent."Course: Outdoor Leadership Program \n\n";
	...
	$email_final = "Thank you for submitting a registration for the Gould Lake's Outdoor Leadership Program.\n
	Please ensure that you mail us the registration package to complete the registration process.\n";
