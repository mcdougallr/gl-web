	      	...
	      	<div class="pure-u-1 pure-u-sm-1-3">
		    	...
		    	<div class="pure-u-1 pure-u-sm-1-3">
				  ...
				  <div class="pure-u-1 pure-u-sm-1-2">
						<div class="form-padding">
							<label>School for Fall 2016</label>
			    ...
			    <div class="pure-u-1"> 
			    	<div class="form-padding">
			      	<label>Fall 2016 School Address</label>
							<label style="font-size: .75em;font-variant: normal;"><em>(if the school is outside the Limestone District School Board)</em></label>
