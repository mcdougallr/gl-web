		...
		<div id="gl-wrapper" style="min-height: 100%">	
			<form novalidate class="pure-form pure-form-stacked" method="post" parsley-validate parsley-required-message="">
				<div class="pure-g">
					...
					<div class="pure-u-1 pure-u-sm-1-2">
						<div class="form-padding">
					 	 	<label>Date of Last Tetanus Shot in the Last 10 Years <span style="font-size: .75em;font-variant: normal;"><em>(Month/Year)</em></span></label>
					...
					<div class="pure-u-1 pure-u-sm-1-2">
			   		...
			   		<div class="pure-u-1">
			   			...
			   			<div class="form-padding-2">
				   			<div class="pure-g">
				   				<div style="margin: 5px 0;" class="pure-u-1 pure-u-sm-5-8 pure-u-md-3-4">
									<label style="display: inline;">Has <?php print $data['student_name_common']; ?> ever been hospitalized?</label>
								</div>
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_hospitalized" type="radio" value="Yes" <?php if (isset($data['student_health_hospitalized'])) {if ($data['student_health_hospitalized'] == "Yes") {print " checked";}} ?> required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_hospitalized" type="radio" value="No" <?php if (isset($data['student_health_hospitalized'])) {if ($data['student_health_hospitalized'] == "No") {print " checked";}} ?> required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>
						...
						<div class="form-padding-2">
							<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_injuries" type="radio" value="Yes" <?php if (isset($data['student_health_injuries'])) {if ($data['student_health_injuries'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_injuries" type="radio" value="No" <?php if (isset($data['student_health_injuries'])) {if ($data['student_health_injuries'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>
						...
						<hr />
					  	<div class="form-padding-2">  
					  		<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_meds" type="radio" value="Yes" <?php if (isset($data['student_health_meds'])) {if ($data['student_health_meds'] == "Yes") {print " checked";}} ?>  required>
						      		<label style="display: inline;">Yes</label>
						      		<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_meds" type="radio" value="No" <?php if (isset($data['student_health_meds'])) {if ($data['student_health_meds'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>						
						...
						<div class="form-padding-2">  
							<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_allergies" type="radio" value="Yes" <?php if (isset($data['student_health_allergies'])) {if ($data['student_health_allergies'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_allergies" type="radio" value="No" <?php if (isset($data['student_health_allergies'])) {if ($data['student_health_allergies'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>	
						...
						<div class="form-padding-2">  
							<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_epipen" type="radio" value="Yes" <?php if (isset($data['student_health_epipen'])) {if ($data['student_health_epipen'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_epipen" type="radio" value="No" <?php if (isset($data['student_health_epipen'])) {if ($data['student_health_epipen'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>	
				    	...
				    	<div class="form-padding-2">  
				    		<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_asthma" type="radio" value="Yes" <?php if (isset($data['student_health_asthma'])) {if ($data['student_health_asthma'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_asthma" type="radio" value="No" <?php if (isset($data['student_health_asthma'])) {if ($data['student_health_asthma'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>	
						...
						<div class="form-padding-2">  
							<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_epilepsy" type="radio" value="Yes" <?php if (isset($data['student_health_epilepsy'])) {if ($data['student_health_epilepsy'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_epilepsy" type="radio" value="No" <?php if (isset($data['student_health_epilepsy'])) {if ($data['student_health_epilepsy'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>	
								</div>
							</div>
						...
						<hr />
					  	<div class="form-padding-2">  
						  	<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_diabetes" type="radio" value="Yes" <?php if (isset($data['student_health_diabetes'])) {if ($data['student_health_diabetes'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_diabetes" type="radio" value="No" <?php if (isset($data['student_health_diabetes'])) {if ($data['student_health_diabetes'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>	  
						...
						<hr />
					  	<div class="form-padding-2">  
						  	<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_counselor" type="radio" value="Yes" <?php if (isset($data['student_health_counselor'])) {if ($data['student_health_counselor'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_counselor" type="radio" value="No" <?php if (isset($data['student_health_counselor'])) {if ($data['student_health_counselor'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>
						...
						<hr />
					  	<div class="form-padding-2">  
						  	<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_anxiety" type="radio" value="Yes" <?php if (isset($data['student_health_anxiety'])) {if ($data['student_health_anxiety'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_anxiety" type="radio" value="No" <?php if (isset($data['student_health_anxiety'])) {if ($data['student_health_anxiety'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>
								</div>
							</div>  
						...
						<div class="form-padding-2">  
							<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_limitations" type="radio" value="Yes" <?php if (isset($data['student_health_limitations'])) {if ($data['student_health_limitations'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_limitations" type="radio" value="No" <?php if (isset($data['student_health_limitations'])) {if ($data['student_health_limitations'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label> 	
								</div>
							</div>
						...
						<hr />
					  	<div class="form-padding-2">  
						  	<div class="pure-g">
								...
								<div class="pure-u-1 pure-u-sm-3-8 pure-u-md-1-4 input-radio-align">
									<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_others" type="radio" value="Yes" <?php if (isset($data['student_health_others'])) {if ($data['student_health_others'] == "Yes") {print " checked";}} ?>  required>
							      	<label style="display: inline;">Yes</label>
							      	<input style="margin: 0 5px;height: 17px;width: 17px;vertical-align: -3px;" name="student_health_others" type="radio" value="No" <?php if (isset($data['student_health_others'])) {if ($data['student_health_others'] == "No") {print " checked";}} ?>  required>
									<label style="display: inline;margin-right: 10px;">No</label>  
								</div>
							</div>
						...
						<hr />
					  	<div class="form-padding-2">	
						   	<label style="display: inline;">To ensure that Gould Lake Outdoor Centre Staff is able to provide adequate nutrition for <?php print $data['student_name_common']; ?> while on trip, please include a few brief details regarding dietary choices or eating habits (vegetarian, hala, vegan, celiac vs gluten free, big appetite, picky eater, average eater, etc.). </label>
