		...
		<div id="gl-wrapper">	
			<form novalidate class="pure-form pure-form-stacked" method="post" parsley-validate parsley-required-message="">
	      		<div class="pure-g">	      	
					...
					<div class="pure-u-1 pure-u-sm-3-4">
						<label>I have read and agree to Gould Lake Outdoor Centre's <a href="../../regfiles/regpolicieslet19.pdf" target="_new">Registration Policies</a>.</label>
					</div>
					<div style="text-align: center;padding: 3px 0;" class="pure-u-1 pure-u-sm-1-4">
						<input style="width: 50px; height: 25px;vertical-align: -6px;" type=checkbox name="policies" required>Yes
					</div>
					<div class="pure-u-1"><hr /></div>
					<div class="pure-u-1 pure-u-sm-3-4">
					...
					<div class="pure-u-1"><hr /></div>
					<div class="pure-u-1 pure-u-sm-3-4">
	          			<label>I give permission for my child's photo and video image to be used on Limestone District School Board approved social media sites.</label>
					</div>
					<div style="text-align: center;padding: 3px 0;" class="pure-u-1 pure-u-sm-1-4">
