		    ...
		    <form novalidate class="pure-form pure-form-stacked" method="post" parsley-validate>
		    	<div class="pure-g">
		    		...
		    		<div class="pure-u-1 pure-u-sm-5-8">
		    			<div class="form-padding">
			    			<label>Phone #1</label>
							<input style="display: inline-block;" name="g1_p1_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],0,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3" required>
							<input style="display: inline-block;" name="g1_p1_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],4,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3" required>
							<input style="display: inline-block;" name="g1_p1_3" type="text" placeholder="####" maxlength="4" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],8,4);} ?>" data-parsley-minlength="4" data-parsley-maxlength="4" required>
							<input style="display: inline-block;" name="g1_p1_4" type="text" placeholder="EXT" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],13);} ?>">
				      	</div> 
			      	</div>    
		    		<div class="pure-u-1 pure-u-sm-3-8">
		    			<div class="form-padding">
		    		...
		    		<div class="pure-u-1 pure-u-sm-5-8">
		    			<div class="form-padding">
			    			<label>Phone #2</label>
							<input style="display: inline-block;" name="g1_p2_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p2'])) {print substr($data['g1_p2'],0,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3">
							<input style="display: inline-block;" name="g1_p2_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p2'])) {print substr($data['g1_p2'],4,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3">
							<input style="display: inline-block;" name="g1_p2_3" type="text" placeholder="####" maxlength="4" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p2'])) {print substr($data['g1_p2'],8,4);} ?>" data-parsley-minlength="4" data-parsley-maxlength="4">
							<input style="display: inline-block;" name="g1_p2_4" type="text" placeholder="EXT" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p2'])) {print substr($data['g1_p2'],13);} ?>">
				      	</div> 
			      	</div>    
			        <div class="pure-u-1">
		    			<div class="form-padding">
		    		...
		    		<div class="pure-u-1 pure-u-sm-5-8">
		    			<div class="form-padding">
			    			<label>Phone #1</label>
							<input style="display: inline-block;" name="g2_p1_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p1'])) {print substr($data['g2_p1'],0,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3">
							<input style="display: inline-block;" name="g2_p1_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p1'])) {print substr($data['g2_p1'],4,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3">
							<input style="display: inline-block;" name="g2_p1_3" type="text" placeholder="####" maxlength="4" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p1'])) {print substr($data['g2_p1'],8,4);} ?>" data-parsley-minlength="4" data-parsley-maxlength="4">
							<input style="display: inline-block;" name="g2_p1_4" type="text" placeholder="EXT" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p1'])) {print substr($data['g2_p1'],13);} ?>">
				      	</div> 
			      	</div>    
		    		<div class="pure-u-1 pure-u-sm-3-8">
		    			<div class="form-padding">
		    		...
		    		<div class="pure-u-1 pure-u-sm-5-8">
		    			<div class="form-padding">
			    			<label>Phone #2</label>
							<input style="display: inline-block;" name="g2_p2_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p2'])) {print substr($data['g2_p2'],0,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3">
							<input style="display: inline-block;" name="g2_p2_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p2'])) {print substr($data['g2_p2'],4,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3">
							<input style="display: inline-block;" name="g2_p2_3" type="text" placeholder="####" maxlength="4" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p2'])) {print substr($data['g2_p2'],8,4);} ?>" data-parsley-minlength="4" data-parsley-maxlength="4">
							<input style="display: inline-block;" name="g2_p2_4" type="text" placeholder="EXT" onKeyPress="return noenter()" value="<?php if (isset($data['g2_p2'])) {print substr($data['g2_p2'],13);} ?>">
				      	</div> 
			      	</div>  
		    		<div class="pure-u-1">
		    			<div class="form-padding">
		    		...
		    		<div class="pure-u-1 pure-u-sm-5-8">
		    			<div class="form-padding">
			    			<label>Phone #1</label>
							<input style="display: inline-block;" name="c_p1_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['c_p1'])) {print substr($data['c_p1'],0,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3" required>
							<input style="display: inline-block;" name="c_p1_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['c_p1'])) {print substr($data['c_p1'],4,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3" required>
							<input style="display: inline-block;" name="c_p1_3" type="text" placeholder="####" maxlength="4"onKeyPress="return noenter()" value="<?php if (isset($data['c_p1'])) {print substr($data['c_p1'],8,4);} ?>" data-parsley-minlength="4" data-parsley-maxlength="4" required>
							<input style="display: inline-block;" name="c_p1_4" type="text" placeholder="EXT" onKeyPress="return noenter()" value="<?php if (isset($data['c_p1'])) {print substr($data['c_p1'],13);} ?>">
				      	</div> 
			      	</div>    
		    		<div class="pure-u-1 pure-u-sm-3-8">
		    			<div class="form-padding">
		    		...
		    		<div class="pure-u-1 pure-u-sm-5-8">
		  				<div class="form-padding">	    			
		  					<label>Phone #2</label>
							<input style="display: inline-block;" name="c_p2_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['c_p2'])) {print substr($data['c_p2'],0,3);} ?>">
							<input style="display: inline-block;" name="c_p2_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['c_p2'])) {print substr($data['c_p2'],4,3);} ?>" >
							<input style="display: inline-block;" name="c_p2_3" type="text" placeholder="####" maxlength="4" onKeyPress="return noenter()" value="<?php if (isset($data['c_p2'])) {print substr($data['c_p2'],8,4);} ?>" >
							<input style="display: inline-block;" name="c_p2_4" type="text" placeholder="EXT" onKeyPress="return noenter()" value="<?php if (isset($data['c_p2'])) {print substr($data['c_p2'],13);} ?>">
				       </div>
			      	</div> 
