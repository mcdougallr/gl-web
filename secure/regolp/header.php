...
<html>
  	<head>
	    ...
	    <link href="../regolp/custom-theme/jquery-ui-1.10.3.custom.css" rel="stylesheet" /> 
	    <link href="../regolp/regcss.css" rel="stylesheet" type="text/css" />
	    
	    <script src="//code.jquery.com/jquery-1.10.1.min.js"></script>
	    <script src="../regolp/jquery-ui-1.10.3.custom.js"></script>
	    <script type="text/javascript" src="../../scripts/parsley/dist/parsley.min.js"></script> 
  	</head>
 	<body>
 		<div id="working"><img id="loading" src="../regolp/loading.gif"/></div>
	  	<div id="reg-header">
	  		<div id=header-top class="pure-g">
			    ...
			    <div id="gl-subtitle" class="pure-u-1 pure-u-md-1-3">
			      	<span>OLP Registration 2018</span> 
			    </div>
			</div>
		</div>
<script>
