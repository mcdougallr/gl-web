...
<html>
<head>
<link href="../regolp/regcssprint.css" rel="stylesheet" type="text/css" />
...
<body>
<div class="pagebreak">
	<div id="gl-title">Gould Lake Outdoor Centre <img id="gl-sunman" src="../regolp/sunnyblack.png" width="61" height="55" alt="sunman.png"></div>
	<h3>OLP Student Registration Package 2018</h3>
	...
	<div class="form-wrapper">
		...
		<h5><em>Home Phone:</em> <?php print $data['g1_p1']; ?></h5>
		<h5><em>Cell Phone:</em> <?php print $data['g1_p2']; ?></h5>
		<h5><em>Address:</em> <?php print $data['g1_address'].", ".$data['g1_city']." ".$data['g1_province'].", ".$data['g1_postalcode']; ?></h5>
	</div>

	<h6>Course Information</h6>
	<div class="form-wrapper">	
		<h5><em>Course: </em>OLP</h5>
		<h5><em>Session Dates:</em> July 26 - Aug 2</h5>
		</div>
</div>

<div class="pagebreak">
	<div id="gl-title">Gould Lake Outdoor Centre <img id="gl-sunman" src="../regolp/sunnyblack.png" width="61" height="55" alt="sunman.png"></div>
	<h3>Student Registration Package 2018</h3>
	...
	<p>I have read the <a href="http://outed.limestone.on.ca/regfiles/regpolicieslet18.pdf" target="_blank">Registration Policies Letter 2018</a> and:</p>
