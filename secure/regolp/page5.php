			...
			<form novalidate class="pure-form pure-form-stacked" method="post" parsley-validate parsley-required-message="">
	      		<div class="pure-g">	      	
					<div class="pure-u-1">
			    		...
			    		<p>Does <?php print $data['student_name_common']; ?> have any siblings registering for Gould Lake courses in 2018? Please provide their names and the course for which they are registering.</p>
