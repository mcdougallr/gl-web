 ...
 {?>
  	<nav>
    	...
    	<div class="nav-text">		    	
			<?php
	    	if ($_SESSION['page6'] == 0 && $page != 6) {print "<div class=\"pageincomplete\">Submit</div>";}
			elseif ($page == 6) {print "<div class=\"pagecurrent\">Submit<i class=\"fa fa-arrow-circle-right\"></i></div>";}
			else {print "<a class=\"pagecomplete\" href=\"page6.php\">Submit<i class=\"fa fa-check-circle\"></i></a>";} 
			?>
		</div>
