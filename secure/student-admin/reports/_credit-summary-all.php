        	...
        	<div class="pure-u-1">
	            <table align=center width=75%>
		        	<?php
			            ...
			            {
			                print "<td width=20%>".$count."</td><td width=30%>".$student['student_name_last']."</td><td width=30%>".$student['student_name_first']."</td><td width=20%>".$student['program_credit']."</td></tr>";
			                $count ++;
			         	}
			            print "</table>";
			       }
