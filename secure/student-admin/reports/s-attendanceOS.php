...
<body>
	<div style="text-align: center;">
		...
		<h2>Outdoor Skills Attendance - <?php print $session_details['session_program_code'].$session_details['session_number'];?></h2>
	</div>
  <table align="center">
  	<tr>
  		<th class="left" width="15%">Last Name</th>
  		<th class="left" width="15%">First Name</th>
  		<th width="10%">T-Shirt</th>
  		<th width="10%">Swim Test</th>
  		<th width="10%">Day 1</th>
  		<th width="10%">Day 2</th>
  		<th width="10%">GB</th>
  		<th width="10%">Day 12</th>
  		<th width="10%">Palmer</th>
  	</tr> 	
  		<?php
  		$count = 1;
