...
<body>
	<div style="text-align: center;">
		...
		<h2>Q/GAP Attendance - <?php print $session_details['session_program_code'].$session_details['session_number'];?></h2>
	</div>
  <table align="center">
  	<tr>
  		<th class="left" width="30%">Last Name</th>
  		<th class="left"  width="30%">First Name</th>
  		<th width="10%">Day 1</th>
  		<th width="10%">Day 2</th>
  		<th width="10%">Day 3</th>
  		<th width="10%">Trip</th>
  	</tr> 	
  		<?php
  		$count = 1;
