...
<body>
	<div style="text-align: center;">
		...
		<h2>Outdoor Pursuits Attendance - <?php print $session_details['session_program_code'].$session_details['session_number'];?></h2>
	</div>
  <table align="center">
  	<tr>
  		<th class="left" width="14%">Last Name</th>
  		<th class="left" width="14%">First Name</th>
  		<th width="8%">T-Shirt</th>
  		<th width="8%">Passport</th>
		<th width="8%">Insurance</th>
  		<th width="8%">Swim Test</th>
  		<th width="8%">Day 1</th>
  		<th width="8%">Day 2</th>
  		<th width="8%">Killarney</th>
  		<th width="8%">Day 11</th>
  		<th width="8%">Adirondacks</th>
  	</tr> 	
  		<?php
  		$count = 1;
  		foreach ($student_results as $student)
			{
			 ...
			 print "<td class=\"center\">".$student['student_shirtsize']."</td>";
  			 print "<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
				 $count++;
			} ?>
 	</table>
</body>
