...
<h1>Print Staff Paysheets</h1>

<div class="pure-g" style="padding: 10px;">
	<form style="width: 100%;" id="med-print" class="pure-form pure-form-stacked" method="POST" action="reports/r-paysheets.php" target="_new">
		<div class="pure-u-1">
		...
		<div class="pure-u-1-3" style="text-align: left;">
			...
			$i = 0;
			$j = 0;
			$stmt = $conn->prepare("SELECT * FROM gl_staff WHERE admin_archive = 'No' ORDER BY staff_name_last, staff_name_common");
			$stmt->execute();
		...
		<div class="pure-u-1" style="text-align: center;font-size: .9em;">				
			<button type="submit" class="plaintext-button"><i class="fa fa-print"></i> print paysheets</button>
		</div>
	</form>
</div>
