		    	...
		    	<div class="pure-g">
		    			...
		    			<div class="form-padding">
							...
							<div class="pure-g">
								<div class="pure-u-1-4">
									<input style="width: 100%;" name="g1_p1_1" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],0,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3" required>
								</div>
								<div class="pure-u-1-4">
									<input style="width: 100%;" name="g1_p1_2" type="text" placeholder="###" maxlength="3" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],4,3);} ?>" data-parsley-minlength="3" data-parsley-maxlength="3" required>
								</div>
								<div class="pure-u-1-4">
									<input style=width: 100%;" name="g1_p1_3" type="text" placeholder="####" maxlength="4" onKeyPress="return noenter()" value="<?php if (isset($data['g1_p1'])) {print substr($data['g1_p1'],8,4);} ?>" data-parsley-minlength="4" data-parsley-maxlength="4" required>
								</div>
								<div class="pure-u-1-4">
					...
					<div class="pure-u-1">
						<p>This section is provided for the second parent/guardian or for a student staying at a location other than his/her regular home
							 during the course, or for parents who may be staying at a separate address during the course. If using 
							 <em>Other</em> in the <em>Relation to</em> dropdown, please specify the relationship
