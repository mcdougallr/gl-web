...
<div id="gl-main">
	...
	<div id="gl-wrapper" style="min-height: 100%">
		<p style="margin-top: 0;">Welcome to the Gould Lake Winter Program registration process.</p>
		<p>Please make your way through the steps. Use the links on the left to return to previous pages if needed.</p>
		<p>If you are filling out multiple registrations, please ensure you complete one registration, before starting another.</p>
		<p style="font-weight: 400;">Let's get started...</p>
		<p>All communication for the winter program will be sent to the email address given below. Please make sure it is one that is checked frequently.</p>
    	<div class="pure-g">
    		<form novalidate class="pure-form pure-form-stacked" method="post" parsley-validate>
			  	...
			  	<div class="pure-u-1 pure-u-md-1-2">
				  	<div class="form-padding">
			      		...
			      		<input class="pure-input-1" name="contact_email_2" type="email" onKeyPress="return noenter()" value="<?php if (isset($data['contact_email'])) {print $data['contact_email'];} ?>" required parsley-equalto="#contact_email"/>
					</div>
				</div>
